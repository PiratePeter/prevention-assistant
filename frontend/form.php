...
<body>
    ...
    <form id="msform">
        ...
        <fieldset>
            ...
            <textarea name="damagedesc" placeholder="Beschreiben Sie den Schaden"></textarea>
            <br>
        ...
        <fieldset>
            ...
            <p>Überprüfen Sie alle Angaben und senden Sie das Formular ab.</p>
            <input type="button" name="previous" class="previous action-button" value="Zurück">
    ...
    <script>
        ...
        $("input[name='damage']").change(function() {
            if ($(this).val() === "yes") {
                $("textarea[name='damagedesc']").css("height", "300px").css("padding", "15px").css("opacity", "1")
            } else {
                $("textarea[name='damagedesc']").css("height", "0px").css("padding", "0px").css("opacity", "0")
            }
        });
        ...
        function startCanvasAnimation(duration = 5000) {
            ...
            createBalls();
            loop();
            if (duration > 0) setTimeout(stopCanvasAnimation, duration);
        }
